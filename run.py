...
if __name__=="__main__" and debug_mode<4:	
	...
	D = DataManager(basename, input_dir, replace_missing=True, filter_features=False, verbose=verbose) 
	...
	import models_p4 
	models_p4.predict(D, res_dir, basename )
